...
//   if (!priority || !dueDate) {
//     return errorResponse(res, 'Priority and Due Date are required');
//   }
//   const dueDateFormatted = new Date(dueDate).getTime();
//   const taskData = { title, description, priority, completed: false, dueDate: dueDateFormatted, createdAt: Date.now() };
//   try {
